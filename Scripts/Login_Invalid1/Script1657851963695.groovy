...
WebUI.setEncryptedText(findTestObject('Object Repository/Page_Facebook  log in or sign up/input_Facebook helps you connect and share _ab63fc'), 
    'vZpYls+TsBYCykFfSrnnLg==')

WebUI.click(findTestObject('Object Repository/Page_Facebook  log in or sign up/button_Log In'))

WebUI.setEncryptedText(findTestObject('Object Repository/Page_Log in to Facebook/input_Not you_pass'), 'VowBJhrOClIVmgEZKy42IQ==')

WebUI.click(findTestObject('Object Repository/Page_Log in to Facebook/button_Log In'))

WebUI.click(findTestObject('Object Repository/Page_(20) Facebook/g'))

WebUI.click(findTestObject('Object Repository/Page_(20) Facebook/span_Desi AS'))

WebUI.click(findTestObject('Object Repository/Page_(20) Desi AS  Facebook/g'))

WebUI.click(findTestObject('Object Repository/Page_(20) Desi AS  Facebook/span_Keluar'))
